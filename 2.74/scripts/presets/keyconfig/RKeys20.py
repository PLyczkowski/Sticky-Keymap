...
kmi = km.keymap_items.new('view3d.manipulator', 'LEFTMOUSE', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('node.select_image', 'LEFTMOUSE', 'DOUBLE_CLICK')
...
kmi_props_setattr(kmi.properties, 'deselect', True) ctrl=True, alt=True)
